...
case class Ticket(
  ...
  @(ApiModelProperty @field)(value = "whish to be applied not before") notBefore: String,
  @(ApiModelProperty @field)(value = "whish to be applied not after") notAfter: String
)
